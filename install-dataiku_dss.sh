#!/bin/bash
# Script to install Dataiku DSS. Dataiku DSS works on Ubuntu, Debian, CentOS, RHEL and Amazon Linux.
...
#Install
dataiku-dss-6.0.1/installer.sh -d Dataiku_dir -p 11000

#Start
Dataiku_dir/bin/dss start

#Browse to http://localhost:11000 
echo "Browse to http://localhost:11000"
